...
class AttendanceDetailController extends GetxController {
  ...
  late List<DateTime> monthlyDates;
  late List<DateTime> weeklyDates;
  @override
  void onInit() {
    super.onInit();
    generateMonthlyDateList();
    generateWeeklyDateList();
  }
  void generateMonthlyDateList() {

    DateTime currentDate = startDate.value;
    monthlyDates = List.generate(31, (index) => currentDate.add(Duration(days: index))).obs;
    update();
  }
  void generateWeeklyDateList() {

    DateTime currentDate = startDate.value;
    weeklyDates = List.generate(8, (index) => currentDate.add(Duration(days: index))).obs;
    update();
  }
