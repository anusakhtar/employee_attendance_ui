...
import '../NewLeave/new_leave.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            Obx(() =>  SizedBox(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              "${leaveController.totalLeaves.value.toInt()} Days",
                              style: Theme.of(context).textTheme.headline6!.merge(
                                TextStyle(
                            ...
                            ClipRRect(
                              ...
                              child: Container(
                                ...
                                child: LinearProgressIndicator(
                                  value: leaveController.totalLeaves.value,
                            ...
                            Text(
                              'Your Balance: ${leaveController.totalLeaves.value.toInt()} Days',
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              "${leaveController.remainingLeaves.value.toInt()} Days",
                              style: Theme.of(context).textTheme.headline6!.merge(
                                TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 22,
                            ...
                            ClipRRect(
                              ...
                              child: Container(
                                ...
                                height: 10,
                                  child: LinearProgressIndicator(
                                    value: (leaveController.remainingLeaves.value / leaveController.totalLeaves.value),
                                  ),
                              ),
                            ),
                            SizedBox(
                            ...
                            Text(
                              'Your Balance: ${leaveController.remainingLeaves.value.toInt()} Days',
                              style: Theme.of(context).textTheme.subtitle1!.merge(
                                TextStyle(
                                  fontWeight: FontWeight.w600,
                                  fontSize: 12,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              "${leaveController.pendingLeaves.value.toInt()} Days",
                              style: Theme.of(context).textTheme.headline6!.merge(
                                TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 22,
                            ...
                            ClipRRect(
                              ...
                              child: Container(
                                ...
                                height: 10,
                                child: LinearProgressIndicator(
                                  value: (leaveController.totalLeaves.value - leaveController.remainingLeaves.value) / leaveController.totalLeaves.value,
                            ...
                            Text(
                              'Your Balance: ${leaveController.pendingLeaves.value.toInt()} Days',
                              style: Theme.of(context).textTheme.subtitle1!.merge(
                                TextStyle(
                                  fontWeight: FontWeight.w600,
                                  fontSize: 12,
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: TabBar(
                    ...
                    // isScrollable: true,
                    onTap: (index) {
                      leaveController.changeTabIndex(index);
                    },
              ...
              Expanded(
                child: Obx(() {
                  switch (leaveController.selectedTabIndex.value) {
                    case 0:
                      return TabContent1();
                    case 1:
                      return TabContent2();
